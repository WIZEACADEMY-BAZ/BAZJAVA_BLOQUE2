...
import com.baz.wizeline.learningspring.enums.AccountType;
...
public class Utils {
    ...
    public static Optional<String> nombreCuentaOptional(BankAccountDTO cuenta) {
        String val = cuenta.getUserName();
        if (val != null && val != "") {
