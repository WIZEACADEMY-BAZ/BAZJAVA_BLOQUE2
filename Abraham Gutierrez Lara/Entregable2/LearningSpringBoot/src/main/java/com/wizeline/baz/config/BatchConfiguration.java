...
import com.wizeline.baz.batch.FailedLoginJob;
...
public class BatchConfiguration {
    ...
    @Autowired
    private FailedLoginJob failedLoginJob;
    ...
    public void scheduledByFixedRate() throws Exception {
        ...
        JobParameters jobParameters = new JobParametersBuilder()
                ...
                .addString("project", "BankAPI")
                .toJobParameters();
        jobLauncher.run(failedLoginJob.failedLoginsReport(), jobParameters);
