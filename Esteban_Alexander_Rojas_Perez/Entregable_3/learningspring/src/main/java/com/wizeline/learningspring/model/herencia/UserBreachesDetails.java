...
public class UserBreachesDetails {
    ...
    public UserBreachesDetails() {
    }

    public UserBreachesDetails(int pwnCount, String description, String logoPath, List<String> dataClasses, boolean isVerified, boolean isFabricated, boolean isSensitive, boolean isRetired, boolean isSpamList, boolean isMalware) {
