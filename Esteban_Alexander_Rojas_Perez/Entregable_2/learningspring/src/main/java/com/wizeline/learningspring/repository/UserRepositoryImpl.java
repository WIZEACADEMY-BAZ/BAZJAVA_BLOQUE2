...
public class UserRepositoryImpl implements UserRepository{
	...
	public void createFile() {
		try {
			...
			throw new ExcepcionGenerica("Fallo al crear archivo");
		}
	}
	...
	public void writeFile(String user, String password) {
		try {
			...
			LOGGER.info("An error occurred " + e.getMessage());
			throw new ExcepcionGenerica("Fallo al escribir archivo");
		}
	}
	...
	public String readFile(String user, String password) {
		...
		try {
	        ...
	        LOGGER.info("An error occurred " + e.getMessage());
			throw new ExcepcionGenerica("Fallo al leer archivo");
	      }
		return result;
	}
}
