...
import com.wizeline.gradle.learningjavagradle.service.ProductosService;
...
import com.wizeline.gradle.learningjavagradle.model.AccountFabrica;
...
public class BankingAccountController {
	...
	//The usage of FeignClient for demo purposes
		 ...
		 //ejercicio Patrones comportamiento(fabrica)
		 @GetMapping("/fabrica")
		 public ResponseEntity<List<Account>> Fabrica(){
			 LOGGER.info(" Patron Fabrica ");
			 AccountFabrica obj = new AccountFabrica();
			 
			 //AccountType NOMINA = AccountType.NOMINA;
			Account cuenta1 = obj.getCuenta(NOMINA);
			 cuenta1.setAccountNumber(34443);
			 cuenta1.setEfectivo(8);
			 cuenta1.tieneFondos();
			 
			 Account cuenta2 = obj.getCuenta(PLATA);
			...
			Account cuenta3 = obj.getCuenta(AHORRO);
			 cuenta3.setAccountNumber(5467);
			 cuenta3.setEfectivo(0);
			 cuenta3.tieneFondos();
			 
			 HttpHeaders responseHeaders = new HttpHeaders();
			 responseHeaders.set("Content-Type", "application/json; charset=UTF-8");
			 return new ResponseEntity(List.of(cuenta1, cuenta2, cuenta3), responseHeaders, HttpStatus.OK);
		 }
		 
		 @GetMapping("/producto")
		 public ResponseEntity<String> ProductosIterator(){
			 HttpHeaders responseHeaders = new HttpHeaders();
			 responseHeaders.set("Content-Type", "application/json; charset=UTF-8");
			return new ResponseEntity<>(ProductosService.impProductos(), responseHeaders, HttpStatus.OK  );
